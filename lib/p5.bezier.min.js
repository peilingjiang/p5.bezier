...
/* harmony export */   "initBezier": () => (/* binding */ initBezier),
/* harmony export */   "newBezier": () => (/* binding */ newBezier),
/* harmony export */   "newBezierObj": () => (/* binding */ newBezierObj)
/* harmony export */ });
/*
...
function initBezier(canvas, strictMode = false) {
  _canvas = canvas
...
function newBezier(pointList, closeType = 'OPEN', accuracy = 7) {
...
function newBezierObj(pointList, closeType = 'OPEN', accuracy = 7) {
  // Define the increment of t based on accuracy
  const tIncrement = p5bezierAccuracyListAll[accuracy]
